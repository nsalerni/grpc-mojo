...
| Official suites | h2spec (RFC 7540/7541, 146 checks), Google protobuf conformance (1476 proto3 binary and JSON tests), the 14 canonical gRPC interop cases in both directions over h2c, TLS, and Unix sockets | part of `pixi run compliance` / `pixi run interop-official` |
