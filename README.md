...
**[📋 Compliance report](https://nsalerni.github.io/grpc-mojo/docs/COMPLIANCE.html)** ([Markdown](docs/COMPLIANCE.md)) — 54 differential checks against protobuf, python-hpack, hyper-h2, h2spec, CPython sockets, and grpcio; regenerated by every CI run.
...
(currently **54/54 checks passing**). Each package repo also runs its own
