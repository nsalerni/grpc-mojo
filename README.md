...
**[📋 Compliance report](https://nsalerni.github.io/grpc-mojo/docs/COMPLIANCE.html)** ([Markdown](docs/COMPLIANCE.md)) — 52 differential checks against protobuf, python-hpack, hyper-h2, h2spec, CPython sockets, and grpcio; regenerated by every CI run.
...
(currently **52/52 checks passing**). Each package repo also runs its own
