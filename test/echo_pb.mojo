...
struct EchoClient(Movable):
    ...
    def split(
        ...
        """
        var sid = self.channel.start_call(
            ECHO_SPLIT_PATH, Metadata(), timeout_ns=timeout_ns
        )
    ...
    def join_start(mut self, *, timeout_ns: Int64 = 0) raises -> UInt32:
        ...
        Raises:
            Error: If the call cannot be started.
        """
        return self.channel.start_call(
            ECHO_JOIN_PATH, Metadata(), timeout_ns=timeout_ns
        )
    ...
    def chat_start(mut self, *, timeout_ns: Int64 = 0) raises -> UInt32:
        ...
        """
        return self.channel.start_call(
            ECHO_CHAT_PATH, Metadata(), timeout_ns=timeout_ns
        )
...
def add_echo_service[
    ...
    split: def(
        EchoRequest, mut ServerContext, mut ServerCall
    ) raises thin -> None,
